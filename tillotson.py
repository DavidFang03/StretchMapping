...
rho0 = 2700  # Densité initiale (kg/m3)
# rhoiv = 1500  # Densité initiale (kg/m3)
u_iv = 5.0e6  # Énergie vaporisation incipiente (J/kg)
u_cv = 15.0e6  # Énergie vaporisation complète (J/kg)
...
props = dict(boxstyle="round", facecolor="white", alpha=0.9, edgecolor="gray", pad=1)
...
ax.text(
    rho0 / 2, (u_iv + u_cv) / 2, eq_4, ha="center", va="center", fontsize=10, bbox=props
)
