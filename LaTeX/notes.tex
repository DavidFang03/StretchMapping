...
\begin{align*}
  \pdv{\tpf}{\rho} &= \frac{1}{3\mue }\alpha\rho^{\frac13-1} \\
...
\end{align*}
Finalement
\[ c_s^2 = \frac{8\alpha\beta}{3\mue\rho^{\frac23}}\frac{\tpf^4}{\sqrt{1+\tpf^2}}\]
...
\begin{tcolorbox}
  ...
  \begin{align*}
    \tpf &= \frac{1}{\mue}\alpha \rho^{1/3}\\
    \alpha &= \frac{1}{(\me c)^{\frac13}}\frac{3h^3}{8\pi m_{\mathrm{p}}} \\
    \beta &= \frac{\pi m_\mathrm{e}^4c^5}{3h^3}
  \end{align*}
\end{tcolorbox}
...
\]
\[
  \Phi'' + \frac{2}{\eta}\Phi' = - \left( \Phi^2 - \frac{1}{y_0^2} \right)^{3/2}
\]
...
\begin{align*}
  u' &= v \\
  v' &= - \left(u^2 - \frac{1}{y_0^2} \right)^{3/2} - \frac{2}{\eta}v
\end{align*}
